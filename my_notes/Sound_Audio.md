...
- [3 Complex number](#3-complex-number)
    ...
    - [3.2 Complex plane](#32-complex-plane)
    - [3.3 Modulus and argument](#33-modulus-and-argument)
    - [3.4 Rotation with complex number](#34-rotation-with-complex-number)
    - [3.5 Polar form](#35-polar-form)
- [4 Euler formula](#4-euler-formula)
    - [4.1 Definition](#41-definition)
    - [4.2 Angular frequency](#42-angular-frequency)
    - [4.3 Rotation with Euler](#43-rotation-with-euler)
        - [4.3.1 Another way of writing -1, i, and -i](#431-another-way-of-writing--1-i-and--i)
        - [4.3.2](#432)
            - [4.3.2.1 Constant](#4321-constant)
            - [4.3.2.2 A line](#4322-a-line)
            - [4.3.2.3 Parabol](#4323-parabol)
            - [4.3.2.4 Sine and cosine waves](#4324-sine-and-cosine-waves)
            - [4.3.2.4.1 Difference frequency](#43241-difference-frequency)
            - [4.3.2.4.2 Same frequency](#43242-same-frequency)
- [5 Integral on Euler Exponent](#5-integral-on-euler-exponent)
    - [5.1 Define integral](#51-define-integral)
    - [5.2 Evaluate Some Examples Using Integral](#52-evaluate-some-examples-using-integral)
        - [5.2.1 Constant Radius](#521-constant-radius)
        - [5.2.2 Sin/Cos waves](#522-sincos-waves)
            - [5.2.2.1 Different Frequency](#5221-different-frequency)
            - [5.2.2.2 Same Frequency](#5222-same-frequency)
    - [5.3 Analysis on sin/cos integral](#53-analysis-on-sincos-integral)
        - [5.3.1 Condition for balance](#531-condition-for-balance)
        - [5.3.2 Number of cycles](#532-number-of-cycles)
        - [5.3.3 Large Radius Frequency](#533-large-radius-frequency)
        - [5.3.4 Large Rotation Frequency](#534-large-rotation-frequency)
        - [5.3.5 Spike with resonance](#535-spike-with-resonance)
            - [5.3.5.1 Real part](#5351-real-part)
            - [5.3.5.2 Imaginary part](#5352-imaginary-part)
    - [5.4 Integral as Dot Product](#54-integral-as-dot-product)
- [6 Inverse of Euler Exponent](#6-inverse-of-euler-exponent)
    - [6.1 Number of frequencies needed for n number of values](#61-number-of-frequencies-needed-for-n-number-of-values)
    - [6.2 change in basis](#62-change-in-basis)
- [7 Fourier transform](#7-fourier-transform)
    - [7.1 Fourier Series](#71-fourier-series)
    - [7.2 Fourier Transform](#72-fourier-transform)
        - [7.3 Discrete Fourier Transform](#73-discrete-fourier-transform)
        - [7.4 Fast Fourier Transform](#74-fast-fourier-transform)
        - [7.5 Nyquist frequency](#75-nyquist-frequency)
        - [7.6 Symmetry for Real Value Input in DFT](#76-symmetry-for-real-value-input-in-dft)
- [8 Window Function](#8-window-function)
    - [8.1 Spectral Leakage](#81-spectral-leakage)
